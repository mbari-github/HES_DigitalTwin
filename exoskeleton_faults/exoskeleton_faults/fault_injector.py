...
------
  CHANNEL 0:
    Sub:  /exo_dynamics/tau_ext_theta         exoskeleton_safety_msgs/Float64Stamped
    Pub:  /exo_dynamics/tau_ext_theta_faulted exoskeleton_safety_msgs/Float64Stamped

  CHANNEL 1:
    Sub:  /trajectory_ref                     exoskeleton_safety_msgs/Float64ArrayStamped
    Pub:  /trajectory_ref_faulted             exoskeleton_safety_msgs/Float64ArrayStamped

  CHANNEL 2:
    Sub:  /torque                             exoskeleton_safety_msgs/Float64Stamped
    Pub:  /torque_faulted                     exoskeleton_safety_msgs/Float64Stamped
  ...
  Always:
    Pub:  /fault_injector/status              exoskeleton_safety_msgs/Float64ArrayStamped
