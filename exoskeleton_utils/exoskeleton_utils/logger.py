...
Subscribed topics:
  /exo_dynamics/debug         exoskeleton_safety_msgs/Float64ArrayStamped
  /exo_dynamics/ff_terms      exoskeleton_safety_msgs/Float64ArrayStamped
  /exo_dynamics/model_debug   exoskeleton_safety_msgs/Float64ArrayStamped   (optional)
  /traj_ctrl/debug            exoskeleton_safety_msgs/Float64ArrayStamped
  /admittance/debug           exoskeleton_safety_msgs/Float64ArrayStamped
  /joint_states               sensor_msgs/JointState                         (optional, redundancy)
  /torque                     exoskeleton_safety_msgs/Float64Stamped         (optional, redundancy)
